  ...
  >
    <div class="container m-auto px-6 py-20 md:px-12 lg:px-20">
      <div class="m-auto text-center lg:w-8/12 xl:w-7/12">
        <h2 class="text-2xl text-gray-800 dark:text-gray-200 font-bold md:text-4xl">
      ...
      >
        <div class="relative z-10 -mx-4 group md:w-6/12 md:mx-0 lg:w-5/12">
          ...
          <div class="relative p-6 space-y-6 lg:p-8">
            ...
            <div>
              <div class="relative flex justify-around">
                <div class="flex items-end">
                  <span class="text-8xl text-gray-800 dark:text-gray-500 font-bold leading-0"
                    >10</span
                  >
                  <div class="pb-2">
                    <span class="block text-2xl text-gray-700 dark:text-gray-500 font-bold"
                      >&euro;</span
                    >
                  </div>
                </div>
            ...
            >
              <span class="text-white font-semibold"> Sign Up and Subscribe </span>
            </button>
            <form v-else action="/api/subscribe" method="POST">
              <input type="hidden" name="lookup_key" value="price_1MjbetKjQsJqvPDtUzzqlZ6m" />
