      ...
      >
        ...
        <nav class="hidden md:flex space-x-10">
          ...
          <nuxt-link to="/categories">
            <span class="text-base font-medium text-gray-500 hover:text-gray-900"> Videos </span>
          </nuxt-link>
          ...
          <nuxt-link to="/ask-jack/search">
            <span class="text-base font-medium text-gray-500 hover:text-gray-900"> Ask Jack </span>
          </nuxt-link>
