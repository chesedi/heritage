<template>
  <div>
    <div class="mb-10">
      ...
      <button
        class="ml-5 p-5 bg-blue-500 transition hover:bg-teal-500 duration-300 ease-in-out delay-150 text-white"
      >
        With Transition
      </button>
      ...
      <button
        class="p-5 ml-5 text-white bg-blue-500 transition ease-in-out delay-150 duration-500 hover:-translate-y-1 hover:scale-110 hover:bg-teal-500"
      >
        Transformation
      </button>
